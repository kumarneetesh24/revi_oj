        ...
        jQuery.ajax(
        {
            ...
            success: function(submission_data)
            {
              if (submission_data['status_code'] == 'PE') {
                ...
                jQuery(element).append(" <img src='/assets/" + img_attr + "' height='24' width='24' data-toggle='tooltip' data-placement='bottom' title='" + submission_data['status_code'] + "' data-original-title='" + Math.round(tooltip * 100) / 100 + "' > <br /><br /> <span><i><b>" + Math.round(tooltip * 100) / 100 + "</b></i></span>");
